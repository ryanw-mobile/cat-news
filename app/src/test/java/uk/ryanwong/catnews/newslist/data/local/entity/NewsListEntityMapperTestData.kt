...
internal object NewsListEntityMapperTestData {

    val newsItemEntityStory = NewsItemEntity(
        listId = 1,
        newsId = 1,
        type = "story",
    ...
    val newsItemEntityWebLink = NewsItemEntity(
        listId = 1,
        newsId = 2,
        type = "weblink",
    ...
    val newsItemEntityUnknown = NewsItemEntity(
        listId = 1,
        newsId = 3,
        type = "some-type-3",
